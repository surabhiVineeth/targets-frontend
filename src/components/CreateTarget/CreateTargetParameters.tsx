...
export interface ICreateTargetParameterProps {}

export default function CreateTargetParameters(
  props: ICreateTargetParameterProps
) {
        ...
        <div className="modal-content-crt">
          ...
          <div className="modal-body-crt">
            ...
            <div className="sub-content-1-parent-wrapper">
              ...
              {areParametersInlineWithSBTiGuidance === 'Yes' &&
                productIntensityId === 'Absolute' && <p className="syc"></p>}
            </div>
          </div>
